<?php
class Yagnik_Yagnik_Block_Adminhtml_Yagnik_Attribute_Set_Main_Formset extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('yagnik')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('yagnik')->__('Name'),
            'note' => Mage::helper('yagnik')->__('For internal use.'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('yagnik')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
