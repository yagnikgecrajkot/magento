<?php
class Yagnik_Yagnik_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    const SCOPE_GLOBAL                          = 1;
    const SCOPE_WEBSITE                         = 2;
    const MODULE_NAME                           = 'Yagnik_Yagnik';
    const ENTITY                                = 'Yagnik_eav_attribute';
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('yagnikattribute/yagnikattribute')->getAttributesByCode();
