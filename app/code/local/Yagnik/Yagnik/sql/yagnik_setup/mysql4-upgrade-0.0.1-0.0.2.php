...
$table = $installer->getConnection()
		->newTable($installer->getTable('yagnik/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('yagnik/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('yagnik/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('yagnik/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id', $installer->getTable('eav/attribute'), 'attribute_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('yagnik EAV Attribute Table');

    $query = "ALTER TABLE `yagnik_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
...
$setup->addAttribute(Yagnik_Yagnik_Model_Resource_Yagnik::ENTITY, 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
    ...
    'global'                     => Yagnik_Yagnik_Model_Resource_Eav_Attribute::SCOPE_STORE,

));

$setup->addAttribute(Yagnik_Yagnik_Model_Resource_Yagnik::ENTITY, 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute(Yagnik_Yagnik_Model_Resource_Yagnik::ENTITY, 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute(Yagnik_Yagnik_Model_Resource_Yagnik::ENTITY, 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'phoneNo',
