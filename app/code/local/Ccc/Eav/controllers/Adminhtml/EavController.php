...
class Ccc_Eav_Adminhtml_EavController extends Mage_Adminhtml_Controller_Action
{
    
    function indexAction()
    {
        $this->_title($this->__('Vendor'))
             ->_title($this->__('Manage Eav Attribute'));
        $this->loadLayout();
        $this->_setActiveMenu('eav/manage');
        $this->_addContent($this->getLayout()->createBlock('eav/adminhtml_eav'));
        $this->renderLayout();
    }
